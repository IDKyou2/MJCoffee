                ...
                <nav class="navbar navbar-expand-lg navbar-light color">
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="micon">
                        <ul class="navbar-nav mb-2 mb-lg-0">
                            ...
                            <li class="nav-item text">
                                <a class="nav-link" aria-current="page" id="beverageLink" href="dashboard.php#sec2">Menu</a>
                            </li>
                            <li class="nav-item text">
                                <a class="nav-link" aria-current="page" id="searchLink" href="dashboard.php#sec3">About</a>
                            </li>
                        </ul>
                       ...
                       <!-- For smaller screens -->
                        <div class="d-flex ml-auto d-lg-none">
                            <div class="basket-container">
                                <img class="navimg1" src="image/basket.svg" width="30px;" height="30px;" loading="lazy" onclick="handleCartClick();" style="cursor: pointer;" />
                                <?php
                    ...
                    <div class="d-none d-lg-flex ml-auto align-items-center">
                        ...
                        <?php } else { ?>
                            <div class="dropdown">
                                <button class="btn dropdown-toggle" style="border-radius: 10px;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Hello, <?php
                                            echo $_SESSION['username'];
                                            ?>
                                </button>
