...
<body>
  ...
  <div class="container">
    <div class="row">
      <button type="button" class="btn" style="width: 200px; margin-left: 40px; background-color:#9A4444; color:white;"
        onclick="location.href='addproduct.php';">
                                ...
                                foreach ($stmt->fetchAll() as $row) {
                                  ...
                                  <tr>
                                    ...
                                    <td class="text-center">
                                      <!--------------------------------------- Edit button ----------------------------------------------->
                                  <a href="adminUpdateProduct.php?fooditemID=<?php echo $row['fooditemID']; ?>"
                                    style="margin-right: 10px;" class="text-decoration-none border-0">
                                    <i class="bi bi-pencil-square" style="font-size: 24px; color:#9A4444"></i>
                                  </a>
                                  <!--------------------------------------- Delete button ----------------------------------------------->
