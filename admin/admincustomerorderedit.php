<?php
include('adminUpdateOrderStatus.php')
    ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container">
        <div class="row">
            <h5 class="fw-bold mb-3">
                All Order History
                <i class="bi bi-chevron-double-right mx-2 text-secondary"></i>
                <span style="color:#9A4444">Order Details</span>
            </h5>

            <div class="d-flex justify-content-end">
                <a href="admincustomerorder.php">
                    <button type="button" class="btn"
                        style="border-radius: 10px; width: 250px; font-size: 18px; background-color:#9A4444; color:white;">Back
                        to Customer Orders</button>
                </a>
            </div>
        </div>
    </div><br>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-8 col-lg-6 mb-6">
                        <div class="card" style="margin-top: 20px; margin-bottom: 10px; border: none;">
                            <div class="card-body">
                                <p class="card-title" style="font-family: Times New Roman, Times, serif; font-size: 22px;">
                                </p><br>
                                <p class="card-title" style="font-family: Times New Roman, Times, serif; font-size: 22px;">
                                    Customer: <strong><?php echo $row['name']; ?></strong></p>
                                <p class="card-text" style="font-family: Times New Roman, Times, serif; font-size: 22px;">
                                    Username: <strong><?php echo $row['username']; ?></strong></p>
                                <p class="card-text" style="font-family: Times New Roman, Times, serif; font-size: 22px;">
                                    Address: <strong><?php echo $row['address']; ?></strong></p>
                                <p class="card-text" style="font-family: Times New Roman, Times, serif; font-size: 22px;">
                                    Mobile Number: <strong><?php echo $row['phonenumber']; ?></strong></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-8 col-lg-6 mb-6">
                        <div class="card"
                            style="margin-top: 20px; margin-bottom: 10px; border: none; background-color: inherit;">
                            <div class="card-body">
                                <span>
                                    <a class="receipt"
                                ...
                                <p class="card-text" style="font-family: Times New Roman, Times, serif; font-size: 22px;">
                                    Order Date:
                                    <strong><?php echo date("F j, Y", strtotime($row['created_at'])) . ', ' . date("g:i A", strtotime($row['created_at'])); ?></strong>
                                </p>
                                <p class="card-text" style="font-family: Times New Roman, Times, serif; font-size: 22px;">
                                    PickUp Date:
                                    <strong><?php echo date("F j, Y", strtotime($row['pickup_at'])) . ', ' . date("g:i A", strtotime($row['pickup_at'])); ?></strong>
                                </p>
                                <p class="card-text" style="font-family: Times New Roman, Times, serif; font-size: 22px;">
                                    Order Total: ₱ <strong><?php echo number_format($row['totalprice'], 2); ?></strong></p>
                            </div>
                        </div>
                    </div>
                </div> <!-- End of row -->
