...
<body>
  ...
  <br><br><br><br><br>
  <center>
    <h1 style="font-family: 'Times New Roman', Times, serif; font-weight: bold; font-size: 35px; color: #9A4444;">
      DASHBOARD </h1>
  </center>
  <br>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
        <div class="card">
          <div class="card-body text-center">
            <h6 class="card-subtitle mb-2 text-muted"><i class="bi bi-person"
                style="color: #9A4444; font-size: 30px;"></i>USERS</h6>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
        <div class="card">
          <div class="card-body text-center">
            <h6 class="card-subtitle mb-2 text-muted"><i class="bi bi-archive-fill"
                style="color: #9A4444; font-size: 30px;"></i> PRODUCTS</h6>
            <h1><?php echo $count; ?></h1>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
        <div class="card">
          <div class="card-body text-center">
            <h6 class="card-subtitle mb-2 text-muted"><i class="bi bi-basket"
                style="color: #9A4444; font-size: 30px;"></i> ORDERS</h6>
            <h1><?php echo $count; ?></h1>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <h1
      style="font-family: 'Times New Roman', Times, serif; font-weight: bold; font-size: 30px; color: #9A4444; margin-bottom: 20px;">
      USERS </h1>
    <div class="row">
      <section class="intro">
                                  ...
                                  foreach ($stmt->fetchAll() as $row) {
                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        <img src="data:<?php echo $img_type; ?>;base64,<?php echo $img_data; ?>" width="200"
                                          height="200">
