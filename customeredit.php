  ...
  <div class="container mt-5">
    <div class="row justify-content-center">
      <div class="col-md-6 p-4" style="border: 2px solid #9A4444; width: 600px;">
        ...
        <p style="font-size: 25px; font-family: Times New Roman;"><strong>UserName:</strong> <?php echo $row['username'] ?></p>
        <form action="admincustomeredit.php" method="get">
          <div class="mb-3">
            <input style="width: 95%; background: white; margin-bottom: 20px;" type="hidden" name="customerID" size="20" value="<?php echo $row['customerID']; ?>" readonly>
          </div>


          <div class="mb-3">
            <label for="newlastname">New Name:</label>
            <input style="width: 95%; background: white; margin-bottom: 20px;" type="text" name="newname" size="20" value="<?php echo $row['name']; ?>">
          </div>

          <div class="mb-3">
            <label for="newusername">New Username:</label>
            <input onInput="checkUsername()" style="width: 95%; background: white; margin-bottom: 20px;" type="text" name="newusername" size="20" id="username" value="<?php echo $row['username']; ?>">
            <p id="check-username"></p>
          </div>

          <div class="mb-3">
            <label for="newaddress">Adress:</label>
            <input style="width: 95%; background: white; margin-bottom: 20px;" type="text" name="newaddress" size="20" value="<?php echo $row['address']; ?>">
          </div>
          ...
          <div class="mb-3">
            ...
            <input style="width: 95%; background: white; margin-bottom: 20px;" type="text" name="newphonenumber" size="20" id="newphonenumber" value="<?php echo $row['phonenumber']; ?>" pattern="09\d{9}" maxlength="11" required oninput="checkPhoneNumber()">
